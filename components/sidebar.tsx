...
type SidebarProps = {
  className?: string
  onSelectTab: (tab: "dashboard" | "chat" | "products" | "marketing" | "crm" | "risk" | "stores") => void
  activeTab: "dashboard" | "chat" | "products" | "marketing" | "crm" | "risk" | "stores"
}
